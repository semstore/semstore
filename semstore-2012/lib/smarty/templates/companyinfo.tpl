<div id="company">
<div class="breadcrumb"> <a href="{$siteRootWebpath}/index.php">Home</a> | Company info </div>
  <h1>Company info </h1>
  ...
  <p>Maecenas est  arcu, pulvinar sit amet, lacinia non, mattis nec, elit. Donec tellus  felis, elementum ac, consectetuer sed, fringilla quis, felis. Vivamus  at quam. Vestibulum placerat, quam id auctor dictum, lacus eros  adipiscing lorem, eleifend vulputate velit turpis eget nisl. Vestibulum  bibendum, dolor vel iaculis <strong>tincidunt</strong>, lorem enim mattis lacus, ac  interdum sem urna vitae tortor. </p>
  <ul>
    <li>proin commodo</li>
  ...
  <p class="specials">companyinfo.tpl</p>
