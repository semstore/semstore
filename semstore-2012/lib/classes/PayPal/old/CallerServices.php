...
class CallerServices extends SOAP_Client
{
    ...
    function &SetAuthFlowParam($SetAuthFlowParamReq)
    {
        ...
        // Handle type objects.
        if (@is_a($SetAuthFlowParamReq, 'XSDType')) {
    ...
    function &GetAuthDetails($GetAuthDetailsReq)
    {
        ...
        // Handle type objects.
        if (@is_a($GetAuthDetailsReq, 'XSDType')) {
