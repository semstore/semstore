...
require_once('SEM/CMS/Modules/eComStore/DataObjects/PaymentTypeDataObject.class.php');

require_once('SEM/CMS/Modules/eComStore/PaymentTypePaymentAttributeGroup.class.php');

class PaymentType extends SEMObject
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function PaymentType ()
        {
                ...
                call_user_func_array(
                        array(&$this, '_PaymentType'.$numArgs),
                        $args);
        }
        
        
        function _PaymentType0 ()
        {
                $this->_initialise();
                $do =& new PaymentTypeDataObject();
	 ...
	 */
        ...
        function &getAttributeGroups ()
        {
                $sql = 'WHERE type_id = ' . $this->getId() .
                        ' ORDER BY idx';
                return PaymentTypePaymentAttributeGroup::find(
        ...
        function addAttributeGroupAtPosition ( &$newGroup, $pos )
        {
                ...
                $sql = 'UPDATE payment_type_attribute_gorup SET idx = idx + 1' .
