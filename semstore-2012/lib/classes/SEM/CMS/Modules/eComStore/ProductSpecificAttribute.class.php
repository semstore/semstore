...
class ProductSpecificAttribute extends SEMObject
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function ProductSpecificAttribute ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_ProductSpecificAttribute'.$numArgs),
                        $args);
        }
        
        
        function _ProductSpecificAttribute0 ()
        {
                $this->_initialise();
