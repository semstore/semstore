...
class ProductSpecificAttributeGroup extends SEMObject
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function ProductSpecificAttributeGroup ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_ProductSpecificAttributeGroup'.$numArgs),
                        $args);
        }
        
        
        function _ProductSpecificAttributeGroup0 ()
        {
                $this->_initialise();
        }
