...
class ProductTypeAttributeLinkDataObject extends AttributeMappedDataObject
{
        /*
	 * Class Constants
	 */
	...
	function TABLE () { return 'product_type_attribute_link'; }
	 ...
	 */
        ...
        function ProductTypeAttributeLinkDataObject ()
        {
                $numArgs = func_num_args();
                $args = func_get_args();
                call_user_func_array(
                        array(&$this, '_ProductTypeAttributeLinkDataObject'.$numArgs),
                        $args);
        }
        
        
        function _ProductTypeAttributeLinkDataObject0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $obj =& new ProductTypeAttributeLinkDataObject();
