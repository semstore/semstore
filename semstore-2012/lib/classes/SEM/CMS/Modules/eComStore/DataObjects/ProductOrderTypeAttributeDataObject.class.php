...
class ProductOrderTypeAttributeDataObject extends AttributeMappedDataObject
{
        /*
	 * Class Constants
	 */
	...
	function TABLE () { return 'product_order_type_attribute'; }
	 ...
	 */
        ...
        function ProductOrderTypeAttributeDataObject ()
        {
                $numArgs = func_num_args();
                $args = func_get_args();
                call_user_func_array(
                        array(&$this, '_ProductOrderTypeAttributeDataObject'.$numArgs),
                        $args);
        }
        
        
        function _ProductOrderTypeAttributeDataObject0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $obj =& new ProductOrderTypeAttributeDataObject();
