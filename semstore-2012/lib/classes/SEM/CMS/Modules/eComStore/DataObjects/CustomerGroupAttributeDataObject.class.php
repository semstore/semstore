...
class CustomerGroupAttributeDataObject extends AttributeMappedDataObject
{
        /*
	 * Class Constants
	 */
	...
	function TABLE () { return 'customer_group_attribute'; }
	 ...
	 */
        ...
        function CustomerGroupAttributeDataObject ()
        {
                $numArgs = func_num_args();
                $args = func_get_args();
                call_user_func_array(
                        array(&$this, '_CustomerGroupAttributeDataObject'.$numArgs),
                        $args);
        }
        
        
        function _CustomerGroupAttributeDataObject0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $obj =& new CustomerGroupAttributeDataObject();
