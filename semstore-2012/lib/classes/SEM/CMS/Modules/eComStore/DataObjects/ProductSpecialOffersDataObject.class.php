...
class ProductSpecialOffersDataObject extends AttributeMappedDataObject
{
        /*
         *
	 * Class Constants
	...
	function TABLE () { return 'product_special_offers'; }
	 ...
	 */
        ...
        function ProductSpecialOffersDataObject ()
        {
                $numArgs = func_num_args();
                $args = func_get_args();
                call_user_func_array(
                        array(&$this, '_ProductSpecialOffersDataObject'.
                                $numArgs),
                        $args);
        }
        
        
        function _ProductSpecialOffersDataObject0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $obj =& new ProductSpecialOffersDataObject();
