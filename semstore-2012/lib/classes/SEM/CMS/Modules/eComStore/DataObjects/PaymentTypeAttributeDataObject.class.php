...
class PaymentTypeAttributeDataObject extends AttributeMappedDataObject
{
        /*
	 * Class Constants
	 */
	...
	function TABLE () { return 'payment_type_attribute'; }
	 ...
	 */
        ...
        function PaymentTypeAttributeDataObject ()
        {
                $numArgs = func_num_args();
                $args = func_get_args();
                call_user_func_array(
                        array(&$this, '_PaymentTypeAttributeDataObject'.$numArgs),
                        $args);
        }
        
        
        function _PaymentTypeAttributeDataObject0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $obj =& new PaymentTypeAttributeDataObject();
