...
class ProductTypeAttributeDataObject extends AttributeMappedDataObject
{
        /*
	 * Class Constants
	 */
	...
	function TABLE () { return 'product_type_attribute'; }
	 ...
	 */
        ...
        function ProductTypeAttributeDataObject ()
        {
                $numArgs = func_num_args();
                $args = func_get_args();
                call_user_func_array(
                        array(&$this, '_ProductTypeAttributeDataObject'.$numArgs),
                        $args);
        }
        
        
        function _ProductTypeAttributeDataObject0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $obj =& new ProductTypeAttributeDataObject();
