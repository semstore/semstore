...
class ProductOrderTypeAttributeGroupDataObject extends AttributeMappedDataObject
{
        /*
	 * Class Constants
	 */
	...
	function TABLE () { return 'product_order_type_attribute_group'; }
	 ...
	 */
        ...
        function ProductOrderTypeAttributeGroupDataObject ()
        {
                $numArgs = func_num_args();
                $args = func_get_args();
                call_user_func_array(
                        array(&$this, '_ProductOrderTypeAttributeGroupDataObject'.$numArgs),
                        $args);
        }
        
        
        function _ProductOrderTypeAttributeGroupDataObject0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $obj =& new ProductOrderTypeAttributeGroupDataObject();
