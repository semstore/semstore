...
class EditGlobalProductAttributeGroupForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function EditGlobalProductAttributeGroupForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_EditGlobalProductAttributeGroupForm'.$numArgs),
                        $args);
        }
        
        
        function _EditGlobalProductAttributeGroupForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
