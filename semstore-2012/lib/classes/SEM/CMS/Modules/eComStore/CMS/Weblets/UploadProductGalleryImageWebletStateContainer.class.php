...
class UploadProductGalleryImageWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadProductGalleryImageWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_UploadProductGalleryImageWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _UploadProductGalleryImageWebletStateContainer0 ()
        {
                ;
        }
