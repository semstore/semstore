...
class UploadPDFWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadPDFWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_UploadPDFWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _UploadPDFWebletStateContainer0 ()
        {
                ;
        }
