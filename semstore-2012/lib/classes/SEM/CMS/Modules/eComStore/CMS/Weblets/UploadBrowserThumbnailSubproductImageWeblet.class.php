...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/UploadBrowserThumbnailSubproductImageWebletStateContainer.class.php');
require_once('SEM/CMS/Modules/eComStore/Product.class.php');
require_once('SEM/CMS/Modules/eComStore/ProductImages.class.php');

class UploadBrowserThumbnailSubproductImageWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadBrowserThumbnailSubproductImageWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_UploadBrowserThumbnailSubproductImageWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _UploadBrowserThumbnailSubproductImageWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new UploadBrowserThumbnailSubproductImageWebletStateContainer();
                ...
                Session::putRef('usbtiWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('usbtiWebletStateContainer');
        ...
        {
                Session::put('usbtiWebletStateContainer', NULL);
        }
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/subproduct_management/upload_subproduct_images/upload_browser_thumbnail_subproduct_image.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/subproduct_management/upload_subproduct_images/upload_browser_thumbnail_subproduct_image_form.tpl');
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                else
                {
                        ...
                        $httpResponse->redirect(
                                ...
                                '/upload_browser_thumbnail_image.php?view=capture_details');
                }
        }
