...
class AddProductSubcategoryForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddProductSubcategoryForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_AddProductSubcategoryForm'.$numArgs),
                        $args);
        }
        
        
        function _AddProductSubcategoryForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
