...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/UploadSubproductBasketImageWebletStateContainer.class.php');
require_once('SEM/CMS/Modules/eComStore/Product.class.php');
require_once('SEM/CMS/Modules/eComStore/ProductImages.class.php');

class UploadSubproductBasketImageWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadSubproductBasketImageWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_UploadSubproductBasketImageWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _UploadSubproductBasketImageWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new UploadSubproductBasketImageWebletStateContainer();
                ...
                Session::putRef('usbiWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('usbiWebletStateContainer');
        ...
        {
                Session::put('usbiWebletStateContainer', NULL);
        }
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/subproduct_management/upload_subproduct_images/upload_basket_subproduct_image.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/subproduct_management/upload_subproduct_images/upload_basket_subproduct_image_form.tpl');
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                else
                {
                        ...
                        $httpResponse->redirect(
                                ...
                                '/upload_basket_subproduct_image.php?view=capture_details');
                }
        }
