...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/PlaceSubproductOnSaleWebletStateContainer.class.php');
...
class PlaceSubproductOnSaleWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function PlaceSubproductOnSaleWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_PlaceSubproductOnSaleWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _PlaceSubproductOnSaleWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new PlaceSubproductOnSaleWebletStateContainer();
                ...
                Session::putRef('psosWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('psosWebletStateContainer');
        ...
        {
                Session::put('psosWebletStateContainer', NULL);
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                /* Create the template */
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/subproduct_management/place_subproduct_on_sale/place_subproduct_on_sale.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/subproduct_management/place_subproduct_on_sale/place_subproduct_on_sale_confirmation.tpl');
        ...
        function _confirm_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                $httpResponse->redirect(
                        ...
                        '/place_subproduct_on_sale.php?view=capture_details');
        }
