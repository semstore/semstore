...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/MakeProductSpecialOfferWebletStateContainer.class.php');
...
class MakeProductSpecialOfferWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function MakeProductSpecialOfferWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_MakeProductSpecialOfferWeblet'.
                                $numArgs),
                        $args
                        );
        }
        ...
        function _MakeProductSpecialOfferWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new MakeProductSpecialOfferWebletStateContainer();
                ...
                Session::putRef('mpsoWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('mpsoWebletStateContainer');
        ...
        {
                Session::put('mpsoWebletStateContainer', NULL);
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                /* Create the template */
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/make_product_special_offer/make_product_special_offer.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/make_product_special_offer/make_product_special_offer_confirmation.tpl');
        ...
        function _confirm_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('make_product_special_offer.php?view=capture_details');
        }
