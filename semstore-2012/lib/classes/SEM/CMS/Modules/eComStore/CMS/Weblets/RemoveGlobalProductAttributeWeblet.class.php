...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/RemoveGlobalProductAttributeWebletStateContainer.class.php');
...
class RemoveGlobalProductAttributeWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function RemoveGlobalProductAttributeWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_RemoveGlobalProductAttributeWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _RemoveGlobalProductAttributeWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new RemoveGlobalProductAttributeWebletStateContainer();
                ...
                Session::putRef('rgpaWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('rgpaWebletStateContainer');
        ...
        {
                Session::put('rgpaWebletStateContainer', NULL);
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                /* Create the template */
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_global_attribute_management/remove_global_product_attribute/remove_global_product_attribute.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_global_attribute_management/remove_global_product_attribute/remove_global_product_attribute_confirmation.tpl');
