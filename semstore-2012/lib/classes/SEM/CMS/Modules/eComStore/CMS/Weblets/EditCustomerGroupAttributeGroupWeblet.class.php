...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/EditCustomerGroupAttributeGroupWebletStateContainer.class.php');
...
class EditCustomerGroupAttributeGroupWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function EditCustomerGroupAttributeGroupWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_EditCustomerGroupAttributeGroupWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _EditCustomerGroupAttributeGroupWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new EditCustomerGroupAttributeGroupWebletStateContainer();
                ...
                $stateContainer->setCustomerGroupAttributeGroupId($this->getCustomerGroupAttributeGroupId());
        ...
        function _restoreWebletState ()
        {
                ...
                $this->setCustomerGroupAttributeGroupId($stateContainer->getCustomerGroupAttributeGroupId());
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                {
                        $this->setCustomerGroupAttributeGroupId($httpRequest->getParameter('groupid'));
                        
                        $attributeGroup =& CustomerGroupCustomerAttributeGroup::findFirst(array('id' => $this->getCustomerGroupAttributeGroupId()), $this->getConnection());
                        
                        $this->setAttributeGroupName($attributeGroup->getName());
                
                        $this->_saveWebletState();
                }
                
                
                $template =& new CMSTemplate('modules/ecomstore/customer_groups/edit_customer_group_attribute_group/edit_customer_group_attribute_group.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/customer_groups/edit_customer_group_attribute_group/edit_customer_group_attribute_group_form.tpl');
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('edit_customer_group_attribute_group.php?view=capture_details');
        }
        ...
        function _capture_details_next ( &$httpRequest, &$httpResponse )
        {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('edit_customer_group_attribute_group.php?view=confirm_details');
                return;
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/customer_groups/edit_customer_group_attribute_group/edit_customer_group_attribute_group.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/customer_groups/edit_customer_group_attribute_group/edit_customer_group_attribute_group_confirmation.tpl');
                $template->assign('breadcrumb',
                        $this->_prepareBreadcrumbArray());
                $template->addStylesheet(
                        $configuration->getParameter('cms_css_webpath') . 
        ...
        function _confirm_details_next ( &$httpRequest, &$httpResponse )
        {
                ...
                $group =  CustomerGroupCustomerAttributeGroup::findFirst(array('id' => $this->getCustomerGroupAttributeGroupId()), $this->getConnection());
                $group->setName($this->getAttributeGroupName());
                $group->commit($this->getConnection());
