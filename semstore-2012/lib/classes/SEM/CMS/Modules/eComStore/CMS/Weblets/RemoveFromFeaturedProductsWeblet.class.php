...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/RemoveFromFeaturedProductsWebletStateContainer.class.php');
...
class RemoveFromFeaturedProductsWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function RemoveFromFeaturedProductsWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_RemoveFromFeaturedProductsWeblet'.
                                $numArgs),
                        $args
                        );
        }
        ...
        function _RemoveFromFeaturedProductsWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new RemoveFromFeaturedProductsWebletStateContainer();
                ...
                Session::putRef('rffpWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('rffpWebletStateContainer');
        ...
        {
                Session::put('rffpWebletStateContainer', NULL);
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                /* Create the template */
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/remove_from_featured_products/remove_from_featured_products.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/remove_from_featured_products/remove_from_featured_products_confirmation.tpl');
        ...
        function _confirm_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                if ( $button == 'Remove Featured Product' )
                {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('remove_from_featured_products.php?view=capture_details');
        }
