...
class UploadBrowserThumbnailImageWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadBrowserThumbnailImageWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_UploadBrowserThumbnailImageWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _UploadBrowserThumbnailImageWebletStateContainer0 ()
        {
                ;
        }
