...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/AddToFeaturedProductsWebletStateContainer.class.php');
...
class AddToFeaturedProductsWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddToFeaturedProductsWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_AddToFeaturedProductsWeblet'.
                                $numArgs),
                        $args
                        );
        }
        ...
        function _AddToFeaturedProductsWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new AddToFeaturedProductsWebletStateContainer();
                ...
                Session::putRef('atfpWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('atfpWebletStateContainer');
        ...
        {
                Session::put('atfpWebletStateContainer', NULL);
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                /* Create the template */
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/add_to_featured_products/add_to_featured_products.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/add_to_featured_products/add_to_featured_products_confirmation.tpl');
        ...
        function _confirm_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                if ( $button == 'Make Featured Product' )
                {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('add_to_featured_products.php?view=capture_details');
        }
