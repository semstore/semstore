...
class ManageCustomerGroupWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function ManageCustomerGroupWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_ManageCustomerGroupWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _ManageCustomerGroupWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        function _default ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/customer_groups/manage_customer_group.tpl');
                ...
                $customerGroup =& CustomerGroup::findFirst(
                        ...
                        $this->getConnection() );
                $template->assign('customerGroup', $customerGroup);
                
                $groups =& $customerGroup->getAttributeGroups();
