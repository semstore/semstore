...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/UploadProductDetailsPageImageWebletStateContainer.class.php');
require_once('SEM/CMS/Modules/eComStore/Product.class.php');
require_once('SEM/CMS/Modules/eComStore/ProductImages.class.php');

class UploadProductDetailsPageImageWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadProductDetailsPageImageWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_UploadProductDetailsPageImageWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _UploadProductDetailsPageImageWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new UploadProductDetailsPageImageWebletStateContainer();
                ...
                Session::putRef('updpiWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('updpiWebletStateContainer');
        ...
        {
                Session::put('updpiWebletStateContainer', NULL);
        }
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/upload_product_images/upload_product_details_page_image.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/upload_product_images/upload_product_details_page_image_form.tpl');
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                else
                {
                        ...
                        $this->_saveWebletState();
                        $httpResponse->redirect('upload_product_details_page_image.php?view=capture_details');
                }
        }
