...
class AddCustomerGroupAttributeGroupForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddCustomerGroupAttributeGroupForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_AddCustomerGroupAttributeGroupForm'.$numArgs),
                        $args);
        }
        
        
        function _AddCustomerGroupAttributeGroupForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
