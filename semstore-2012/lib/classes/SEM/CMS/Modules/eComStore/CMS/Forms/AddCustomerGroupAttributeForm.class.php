...
class AddCustomerGroupAttributeForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddCustomerGroupAttributeForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_AddCustomerGroupAttributeForm'.$numArgs),
                        $args);
        }
        
        
        function _AddCustomerGroupAttributeForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
