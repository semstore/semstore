...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/EditGlobalProductAttributeGroupWebletStateContainer.class.php');
require_once('SEM/CMS/Modules/eComStore/CMS/Forms/EditGlobalProductAttributeGroupForm.class.php');
...
class EditGlobalProductAttributeGroupWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function EditGlobalProductAttributeGroupWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_EditGlobalProductAttributeGroupWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _EditGlobalProductAttributeGroupWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new EditGlobalProductAttributeGroupWebletStateContainer();
                ...
                Session::putRef('egpagWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('egpagWebletStateContainer');
        ...
        {
                Session::put('egpagWebletStateContainer', NULL);
        }
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_global_attribute_management/edit_global_product_attribute_group/edit_global_product_attribute_group.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_global_attribute_management/edit_global_product_attribute_group/edit_global_product_attribute_group_form.tpl');
                ...
                $form =& new EditGlobalProductAttributeGroupForm();
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                $this->_saveWebletState();
                return $httpResponse->redirect('edit_global_product_attribute_group.php?view=capture_details');
        }
        ...
        function _capture_details_next ( &$httpRequest, &$httpResponse )
        {
                ...
                if ( $group->getName() != $this->getGroupName() &&
                        eComStoreUtils::productGlobalAttributeGroupWithNameExists(
                        $this->getGroupName(),
                ...
                if ( count($errors) > 0 )
                {
                        $this->setView('capture_details');
                        $this->_saveWebletState();
                        $httpResponse->redirect('edit_global_product_attribute_group.php?view=capture_details');
                        return;
                }
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('edit_global_product_attribute_group.php?view=confirm_details');
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_global_attribute_management/edit_global_product_attribute_group/edit_global_product_attribute_group.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_global_attribute_management/edit_global_product_attribute_group/edit_global_product_attribute_group_confirmation.tpl');
                $template->assign('breadcrumb',
                        $this->_prepareBreadcrumbArray());
                $template->addStylesheet(
                        $configuration->getParameter('cms_css_webpath') . 
