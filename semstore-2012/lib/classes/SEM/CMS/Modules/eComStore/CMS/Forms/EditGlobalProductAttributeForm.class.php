...
class EditGlobalProductAttributeForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function EditGlobalProductAttributeForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_EditGlobalProductAttributeForm'.$numArgs),
                        $args);
        }
        
        
        function _EditGlobalProductAttributeForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
