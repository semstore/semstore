...
class AddSubproductWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddSubproductWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_AddSubproductWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _AddSubproductWebletStateContainer0 ()
        {
                ;
        }
