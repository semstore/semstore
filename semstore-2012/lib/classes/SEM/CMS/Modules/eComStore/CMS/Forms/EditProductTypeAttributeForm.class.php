...
class EditProductTypeAttributeForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function EditProductTypeAttributeForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_EditProductTypeAttributeForm'.$numArgs),
                        $args);
        }
        
        
        function _EditProductTypeAttributeForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
