...
class UploadProductDetailsPageImageWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadProductDetailsPageImageWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_UploadProductDetailsPageImageWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _UploadProductDetailsPageImageWebletStateContainer0 ()
        {
                ;
        }
