...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/UploadProductBasketImageWebletStateContainer.class.php');
require_once('SEM/CMS/Modules/eComStore/Product.class.php');
require_once('SEM/CMS/Modules/eComStore/ProductImages.class.php');

class UploadProductBasketImageWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadProductBasketImageWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_UploadProductBasketImageWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _UploadProductBasketImageWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        function getNewProductBasketImageFile ()
        {
                return $this->newProductBasketImageFile;
        }
        
        
        function setNewProductBasketImageFile ( $file )
        {
                $this->newProductBasketImageFile = $file;
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new UploadProductBasketImageWebletStateContainer();
                ...
                Session::putRef('upbiWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('upbiWebletStateContainer');
        ...
        {
                Session::put('upbiWebletStateContainer', NULL);
        }
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/upload_product_images/upload_basket_image.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/upload_product_images/upload_basket_image_form.tpl');
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                else
                {
                        ...
                        $this->_saveWebletState();
                        $httpResponse->redirect('upload_baasket_image.php?view=capture_details');
                }
        }
        ...
        function _capture_details_next ( &$httpRequest, &$httpResponse )
        {
                ...
                if ( $errors > 0 )
                {
                        $this->setView('capture_details');
                        $this->_saveWebletState();
                        $httpResponse->redirect('upload_basket_image.php?view=capture_details');
                        return;
                }
                ...
                eComStoreCMSUtils::createBasketImage(
                        $this->getTmpUploadsPath() . '/' .
                                $this->getUploadedImageFile(),
                        $this->getTmpUploadsPath() . '/' .
                                'prd'.$product->getId().'_bsk.png'
                        );
                $this->setNewProductBasketImageFile(
                        'prd'.$product->getId().'_bsk.png');
                ...
                eComStoreCMSUtils::_ftpMoveFile(
                        ...
                        $this->getTmpUploadsPath() . '/' .
                                $this->getNewProductBasketImageFile(),
                ...
                $httpResponse->redirect('manage_product_images.php?productid=' .
                        $product->getId());
        }
