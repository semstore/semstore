...
class EditProductTypeAttributeGroupForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function EditProductTypeAttributeGroupForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_EditProductTypeAttributeGroupForm'.$numArgs),
                        $args);
        }
        
        
        function _EditProductTypeAttributeGroupForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
