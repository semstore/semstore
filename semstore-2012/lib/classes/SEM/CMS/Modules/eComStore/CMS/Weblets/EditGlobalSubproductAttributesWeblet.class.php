...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/EditGlobalSubproductAttributesWebletStateContainer.class.php');
...
class EditGlobalSubproductAttributesWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function EditGlobalSubproductAttributesWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_EditGlobalSubproductAttributesWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _EditGlobalSubproductAttributesWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new EditGlobalSubproductAttributesWebletStateContainer();
                ...
                Session::putRef('esgaWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('esgaWebletStateContainer');
        ...
        {
                Session::put('esgaWebletStateContainer', NULL);
        }
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                else
                {
                        ...
                        $groups =& $subproduct->getProductGlobalAttributeGroups();
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/subproduct_management/edit_global_subproduct_attributes/edit_global_subproduct_attributes.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/subproduct_management/edit_global_subproduct_attributes/edit_global_subproduct_attributes_form.tpl');
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                $httpResponse->redirect(
                        ...
                        '/edit_global_subproduct_attributes.php?view=capture_details');
        }
        ...
        function _capture_details_next ( &$httpRequest, &$httpResponse )
        {
                ...
                $httpResponse->redirect(
                        $configuration->getParameter('cms_root_webpath') .
                        '/ecomstore/product_catalogue/subproduct_management' .
                        '/edit_global_subproduct_attributes.php?view=confirm_details');
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                /* Prepare the Template */
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/edit_global_subproduct_attributes/edit_global_subproduct_attributes.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/edit_global_subproduct_attributes/edit_global_subproduct_attributes_confirmation.tpl');
                $template->assign('breadcrumb',
                        $this->_prepareBreadcrumbArray());
                $template->addStylesheet(
                        $configuration->getParameter('cms_css_webpath') . 
