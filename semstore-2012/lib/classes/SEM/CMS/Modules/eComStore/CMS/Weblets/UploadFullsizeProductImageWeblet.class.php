...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/UploadFullsizeProductImageWebletStateContainer.class.php');
require_once('SEM/CMS/Modules/eComStore/Product.class.php');
require_once('SEM/CMS/Modules/eComStore/ProductImages.class.php');

class UploadFullsizeProductImageWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadFullsizeProductImageWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_UploadFullsizeProductImageWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _UploadFullsizeProductImageWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new UploadFullsizeProductImageWebletStateContainer();
                ...
                Session::putRef('ufspiWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('ufspiWebletStateContainer');
        ...
        {
                Session::put('ufspiWebletStateContainer', NULL);
        }
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/upload_product_images/upload_fullsize_product_image.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/upload_product_images/upload_fullsize_product_image_form.tpl');
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                else
                {
                        ...
                        $this->_saveWebletState();
                        $httpResponse->redirect('upload_fullsize_product_image.php?view=capture_details');
                }
        }
        ...
        function _capture_details_next ( &$httpRequest, &$httpResponse )
        {
                ...
                eComStoreCMSUtils::createProductImage(
                        ...
                        $this->getTmpUploadsPath() . '/' .
                                'prd'.$product->getId().'.png'
                        );
                $this->setNewProductImageFile('prd'.$product->getId().'.png');
