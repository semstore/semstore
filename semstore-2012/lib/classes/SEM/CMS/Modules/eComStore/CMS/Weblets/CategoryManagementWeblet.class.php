...
class CategoryManagementWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function CategoryManagementWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_CategoryManagementWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _CategoryManagementWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        function _default ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/catalogue_management/index.tpl');
                ...
                $roots =& ProductCategory::getRootCategories(
                        $this->getConnection() );
                $template->assign('roots', $roots);
