...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/EditProductTypeAttributesWebletStateContainer.class.php');
...
class EditProductTypeAttributesWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function EditProductTypeAttributesWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_EditProductTypeAttributesWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _EditProductTypeAttributesWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new EditProductTypeAttributesWebletStateContainer();
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                else
                {
                        ...
                        $groups =& $product->getProductTypeAttributeGroups();
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/edit_product_type_attributes/edit_product_type_attributes.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/edit_product_type_attributes/edit_product_type_attributes_form.tpl');
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('edit_product_type_attributes.php?view=capture_details');
        }
        ...
        function _capture_details_next ( &$httpRequest, &$httpResponse )
        {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('edit_product_type_attributes.php?view=confirm_details');
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/edit_product_type_attributes/edit_product_type_attributes.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/edit_product_type_attributes/edit_product_type_attributes_confirmation.tpl');
                $template->assign('breadcrumb',
                        $this->_prepareBreadcrumbArray());
                $template->addStylesheet(
                        $configuration->getParameter('cms_css_webpath') . 
