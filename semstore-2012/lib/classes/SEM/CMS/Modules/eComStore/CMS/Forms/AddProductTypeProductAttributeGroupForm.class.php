...
class AddProductTypeProductAttributeGroupForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddProductTypeProductAttributeGroupForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_AddProductTypeProductAttributeGroupForm'.$numArgs),
                        $args);
        }
        
        
        function _AddProductTypeProductAttributeGroupForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
