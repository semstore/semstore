...
class AddTopLevelProductCategoryForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddTopLevelProductCategoryForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_AddTopLevelProductCategoryForm'.$numArgs),
                        $args);
        }
        
        
        function _AddTopLevelProductCategoryForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
