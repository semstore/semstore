...
class ProductGlobalAttributeManagementWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function ProductGlobalAttributeManagementWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_ProductGlobalAttributeManagementWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _ProductGlobalAttributeManagementWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        function _saveWebletState ()
        {
                ...
                Session::putRef('pgamWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('pgamWebletStateContainer');
        ...
        {
                Session::put('pgamWebletStateContainer', NULL);
        }
        ...
        function _default ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_global_attribute_management/index.tpl');
                ...
                $groups =& eComStoreUtils::findProductGlobalAttributeGroups(
