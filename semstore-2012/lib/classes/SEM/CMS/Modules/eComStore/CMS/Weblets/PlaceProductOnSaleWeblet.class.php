...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/PlaceProductOnSaleWebletStateContainer.class.php');
...
class PlaceProductOnSaleWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function PlaceProductOnSaleWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_PlaceProductOnSaleWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _PlaceProductOnSaleWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new PlaceProductOnSaleWebletStateContainer();
                ...
                Session::putRef('pposWebletStateContainer',
                        $stateContainer);
        }
        ...
        {
                $stateContainer =& Session::getRef('pposWebletStateContainer');
        ...
        {
                Session::put('pposWebletStateContainer', NULL);
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                /* Create the template */
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/place_product_on_sale/place_product_on_sale.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/place_product_on_sale/place_product_on_sale_confirmation.tpl');
        ...
        function _confirm_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('place_product_on_sale.php?view=capture_details');
        }
