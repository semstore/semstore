...
class UploadProductDetailsPageSubproductImageWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadProductDetailsPageSubproductImageWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_UploadProductDetailsPageSubproductImageWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _UploadProductDetailsPageSubproductImageWebletStateContainer0 ()
        {
                ;
        }
