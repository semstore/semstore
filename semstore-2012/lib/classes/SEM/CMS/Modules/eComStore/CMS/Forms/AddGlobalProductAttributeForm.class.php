...
class AddGlobalProductAttributeForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddGlobalProductAttributeForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_AddGlobalProductAttributeForm'.$numArgs),
                        $args);
        }
        
        
        function _AddGlobalProductAttributeForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
