...
class AddProductTypeProductAttributeForm extends Form
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddProductTypeProductAttributeForm ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_AddProductTypeProductAttributeForm'.$numArgs),
                        $args);
        }
        
        
        function _AddProductTypeProductAttributeForm0 ()
        {
                $this->_initialize();
                $this->_initWidgets();
        }
