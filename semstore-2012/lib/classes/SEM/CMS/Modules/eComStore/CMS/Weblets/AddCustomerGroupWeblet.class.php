...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/AddCustomerGroupWebletStateContainer.class.php');
...
class AddCustomerGroupWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddCustomerGroupWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_AddCustomerGroupWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _AddCustomerGroupWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new AddCustomerGroupWebletStateContainer();
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/customer_groups/add_customer_group/add_customer_group.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/customer_groups/add_customer_group/add_customer_group_form.tpl');
        ...
        function _capture_details_submit ( &$httpRequest, &$httpResponse )
        {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('add_customer_group.php?view=capture_details');
        }
        ...
        function _capture_details_next ( &$httpRequest, &$httpResponse )
        {
                ...
                $this->_saveWebletState();
                $httpResponse->redirect('add_customer_group.php?view=confirm_details');
        }
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/customer_groups/add_customer_group/add_customer_group.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/customer_groups/add_customer_group/add_customer_group_confirmation.tpl');
                $template->assign('breadcrumb',
                        $this->_prepareBreadcrumbArray());
                $template->addStylesheet(
                        $configuration->getParameter('cms_css_webpath') . 
