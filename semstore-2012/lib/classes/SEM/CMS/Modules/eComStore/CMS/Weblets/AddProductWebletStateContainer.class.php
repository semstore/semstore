...
class AddProductWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function AddProductWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_AddProductWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _AddProductWebletStateContainer0 ()
        {
                ;
        }
