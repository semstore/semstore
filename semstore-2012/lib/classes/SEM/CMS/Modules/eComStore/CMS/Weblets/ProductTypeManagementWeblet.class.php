...
class ProductTypeManagementWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function ProductTypeManagementWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_ProductTypeManagementWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _ProductTypeManagementWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        function _default ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_type_management/index.tpl');
                ...
                $types =& eComStoreUtils::findProductTypes(
