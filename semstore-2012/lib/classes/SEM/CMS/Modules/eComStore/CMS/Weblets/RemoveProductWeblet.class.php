...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/RemoveProductWebletStateContainer.class.php');
...
class RemoveProductWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function RemoveProductWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_RemoveProductWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _RemoveProductWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new RemoveProductWebletStateContainer();
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                /* Create the template */
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/remove_product/remove_product.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/remove_product/remove_product_confirmation.tpl');
