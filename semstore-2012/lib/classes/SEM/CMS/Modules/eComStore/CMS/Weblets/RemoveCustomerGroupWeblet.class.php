...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/RemoveCustomerGroupWebletStateContainer.class.php');
...
class RemoveCustomerGroupWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function RemoveCustomerGroupWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_RemoveCustomerGroupWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _RemoveCustomerGroupWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new RemoveCustomerGroupWebletStateContainer();
        ...
        function _confirm_details ( &$httpRequest, &$httpResponse )
        {
                ...
                {
                        $group =& CustomerGroup::findFirst(array('id' => $this->getGroupId()),
                                $this->getConnection() );
                ...
                /* Create the template */
                $template =& new CMSTemplate('modules/ecomstore/customer_groups/remove_customer_group/remove_customer_group.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/customer_groups/remove_customer_group/remove_customer_group_confirmation.tpl');
