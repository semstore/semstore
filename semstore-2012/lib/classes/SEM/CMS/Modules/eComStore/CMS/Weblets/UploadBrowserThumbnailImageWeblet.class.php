...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/UploadBrowserThumbnailImageWebletStateContainer.class.php');
require_once('SEM/CMS/Modules/eComStore/Product.class.php');
require_once('SEM/CMS/Modules/eComStore/ProductImages.class.php');

class UploadBrowserThumbnailImageWeblet extends Weblet
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadBrowserThumbnailImageWeblet ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array( &$this, '_UploadBrowserThumbnailImageWeblet'.$numArgs),
                        $args
                        );
        }
        
        
        function _UploadBrowserThumbnailImageWeblet0 ()
        {
                $this->_initialize();
        }
	 ...
	 */
        ...
        {
                $stateContainer =& new UploadBrowserThumbnailImageWebletStateContainer();
        ...
        function _capture_details ( &$httpRequest, &$httpResponse )
        {
                ...
                $template =& new CMSTemplate('modules/ecomstore/product_catalogue/product_management/upload_product_images/upload_browser_thumbnail_image.tpl');
                $template->autoconfigure($this->getConfigurator());
                $template->assign('subtemplate', 'modules/ecomstore/product_catalogue/product_management/upload_product_images/upload_browser_thumbnail_image_form.tpl');
