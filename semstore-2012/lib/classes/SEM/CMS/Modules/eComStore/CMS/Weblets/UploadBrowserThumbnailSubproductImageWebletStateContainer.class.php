...
class UploadBrowserThumbnailSubproductImageWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadBrowserThumbnailSubproductImageWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_UploadBrowserThumbnailSubproductImageWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _UploadBrowserThumbnailSubproductImageWebletStateContainer0 ()
        {
                ;
        }
