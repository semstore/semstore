...
class UploadFullsizeSubproductImageWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function UploadFullsizeSubproductImageWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_UploadFullsizeSubproductImageWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _UploadFullsizeSubproductImageWebletStateContainer0 ()
        {
                ;
        }
