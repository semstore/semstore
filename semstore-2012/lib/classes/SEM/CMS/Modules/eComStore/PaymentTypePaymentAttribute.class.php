...
class PaymentTypePaymentAttribute extends SEMObject
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function PaymentTypePaymentAttribute ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_PaymentTypePaymentAttribute'.$numArgs),
                        $args);
        }
        
        
        function _PaymentTypePaymentAttribute0 ()
        {
                $this->_initialise();
                $do =& new PaymentTypeAttributeDataObject();
	 ...
	 */
        ...
        function &find ( $criteria, &$connection )
        {
                ...
                {
                        $do =& $doArr[$index];
                        $attribute =& new PaymentTypePaymentAttribute();
	 ...
	 */
        ...
        function remove ( $maintainIntegrity = TRUE )
        {
                ...
                {
                        $this->removePaymentAttributeLinks();
                }
                ...
                $sql = 'UPDATE payment_type_attribute ' .
                        'SET idx = idx - 1 ' .
                        'WHERE idx > ' . $idx;
        ...
        function removePaymentAttributeLinks ()
        {
                $sql = 'DELETE FROM payment_type_attribute_link ' .
        ...
        function &getGroup ()
        {
                return PaymentTypePaymentAttributeGroup::findFirst(
