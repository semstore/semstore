...
class CMSUserDataObject extends AttributeMappedDataObject
{
        /*
         *
	 * Class Constants
	...
	function TABLE () { return 'cms_user'; }
	 ...
	 */
        ...
        function CMSUserDataObject ()
        {
                $numArgs = func_num_args();
                $args = func_get_args();
                call_user_func_array(
                        array(&$this, '_CMSUserDataObject'.$numArgs),
                        $args);
        }
        
        
        function _CMSUserDataObject0 ()
        {
                $this->_initialize();
        }
