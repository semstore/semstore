...
class MySEMLoginTemplate extends WebsiteTemplate
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function MySEMLoginTemplate ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_MySEMLoginTemplate'.$numArgs),
                        $args );
        }
        
        
        function _MySEMLoginTemplate0 ()
        {
                $this->_initialize();
        }
        
        
        function _MySEMLoginTemplate1 ( $content )
        {
                $this->_initialize();
        ...
        function _MySEMLoginTemplate2 ( &$configuration, &$dbConnection )
        {
                $this->_initialize();
        ...
        function _MySEMLoginTemplate3 ( &$configuration, &$dbConnection, $content )
        {
                $this->_initialize();
                $this->autoconfigure($configuration);
                $this->setConnection($dbConnection);
	 ...
	 */
        ...
        function autoconfigure ( &$config )
        {
                ...
                $this->setCentreTemplate('login.tpl');
