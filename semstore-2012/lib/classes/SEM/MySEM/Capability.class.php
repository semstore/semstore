...
require_once('SEM/MySEM/DataObjects/CapabilityDataObject.class.php');

class Capability extends SEMObject
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function Capability ()
        {
                ...
                call_user_func_array(
                        array(&$this, '_Capability'.$numArgs),
                        $args);
        }
        
        
        function _Capability0 ()
        {
                $this->_initialise();
                $do =& new CapabilityDataObject();
