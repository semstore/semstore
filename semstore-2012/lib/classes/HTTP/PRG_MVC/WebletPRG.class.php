...
class WebletPRG extends SEMObject
{
        /**
         *
	 * Class Constants
	 ...
	 */
        ...
        function WebletPRG ()
        {
                ...
                $args =& func_get_args();
                call_user_func_array( array( &$this, '_WebletPRG'.$numArgs),  $args);
        }
	 ...
	 */
        ...
        function getDefaultObjectIdValue ()
        {
                return $this->defaultOid;
        }
        
        
        function setDefaultObjectIdValue ( $defOId )
        {
                $this->defaultOid = $defOId;
        }
	 ...
	 */
        ...
        function run ()
        {
                ...
                if ( !isset($oidValue) || $oidValue == '' )
                {
                        ...
                        $oidValue = $this->getDefaultObjectIdValue();
                        $state =& Session::getRef($oidValue);
        ...
        function runController ()
        {
                ...
                if ( !isset($action) || $action == '' )
                {
                        ...
                        $redirect =  $this->callAction($this->getActionStage());
                }
                else
                {
                        Debug::debugMsg(DebugLevel::DEBUG(),
