...
class JusteCommerce3ColumnTemplate extends JusteCommerceTemplate
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function JusteCommerce3ColumnTemplate ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_JusteCommerce3ColumnTemplate'.$numArgs),
                        $args );
        }
        
        
        function _JusteCommerce3ColumnTemplate0 ()
        {
                $this->_initialize();
                $this->_prepare();
        }
        ...
        function _JusteCommerce3ColumnTemplate1 ( &$config )
        {
                $this->_initialize();
        ...
        function _JusteCommerce3ColumnTemplate2 ( &$config, &$connection )
        {
                $this->_initialize();
                $this->autoconfigure($config);
        ...
        function _JusteCommerce3ColumnTemplate3 ( &$config, &$connection, $template )
        {
                $this->_initialize();
                $this->autoconfigure($config);
                $this->setConnection($connection);
