...
class EmailTemplate extends JusteCommerceAbstractTemplate
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function EmailTemplate ()
        {
                ...
                call_user_func_array(
                        array(&$this, '_EmailTemplate'.$numArgs),
                        $args );
        }
        
        
        function _EmailTemplate0 ()
        {
                $this->_initialize();
                $this->_prepare();
        }
        ...
        function _EmailTemplate1 ( &$config )
        {
                $this->_initialize();
        ...
        function _EmailTemplate2 ( &$config, &$connection )
        {
                $this->_initialize();
                $this->autoconfigure($config);
        ...
        function _EmailTemplate3 ( &$config, &$connection, $template )
        {
                $this->_initialize();
                $this->autoconfigure($config);
                $this->setConnection($connection);
