...
class JusteCommerceUtils extends SEMObject
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function JusteCommerceUtils ()
        {
                die("Class 'JusteCommerceUtils' is abstract and cannot be instantiated");
        }
	 ...
	 */
        ...
        */
        ...
        {
                $product =&
                        JusteCommerceUtils::findProductWithName($name, $connection);
        ...
        {
                $group =&
                        JusteCommerceUtils::findProductGlobalAttributeGroupWithName(
                                $name, $connection);
        ...
        {
                $attribute =&
                        JusteCommerceUtils::findProductGlobalAttributeWithName(
                                $name, $connection);
        ...
        {
                $type =&
                        JusteCommerceUtils::findProductTypeWithName(
                                $name, $connection);
        ...
        {
                $group =&
                        JusteCommerceUtils::findProductTypeAttributeGroupWithName(
                                $name, $connection);
        ...
        function productTypeAttributeWithNameExists ( $name, &$connection )
        {
                $attribute =&
                        JusteCommerceUtils::findProductTypeAttributeWithName(
                                $name, $connection);
