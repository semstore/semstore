...
class CustomerMyAccountWebletStateContainer extends WebletStateContainer
{
        /*
         *
	 * Class Constants
	 ...
	 */
        ...
        function CustomerMyAccountWebletStateContainer ()
        {
                $numArgs = func_num_args();
                $args =& func_get_args();
                call_user_func_array(
                        array(&$this, '_CustomerMyAccountWebletStateContainer'.$numArgs),
                        $args);
        }
        
        
        function _CustomerMyAccountWebletStateContainer0 ()
        {
                ;
        }
