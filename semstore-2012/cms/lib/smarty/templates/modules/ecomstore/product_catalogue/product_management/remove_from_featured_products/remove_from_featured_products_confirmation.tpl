...
<p>Please confirm that you wish to remove the following product from the featured products.</p>
...
<input name="button" value="Remove Featured Product" type="submit" />
