...
require_once('SEM/CMS/Weblets/UpdateUserPrivilegesWeblet.class.php');
...
if ( !$loggedInUser->hasCapability('CMS_URM_UPDATE_USERS') )
{
        SiteUtils::redirect(
                $configuration->getParameter('cms_root_webpath') .
                '/access_denied.php');
...
$weblet =& new UpdateUserPrivilegesWeblet();
