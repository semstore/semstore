...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/ManageOrderWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('orderid');

$weblet =& new ManageOrderWeblet();
$weblet->autoconfigure($GLOBALS['configuration']);
$weblet->setConnection($GLOBALS['dbConnection']);
$weblet->setOrderId($id);
$weblet->run();
