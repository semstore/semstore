...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/AddProductTypeProductAttributeGroupWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('typeid');

$weblet =& new AddProductTypeProductAttributeGroupWeblet();
