...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/UploadBrowserThumbnailSubproductImageWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('subproductid');

$weblet =& new UploadBrowserThumbnailSubproductImageWeblet();
