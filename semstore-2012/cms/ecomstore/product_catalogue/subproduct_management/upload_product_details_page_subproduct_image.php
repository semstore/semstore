...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/UploadProductDetailsPageSubproductImageWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('subproductid');

$weblet =& new UploadProductDetailsPageSubproductImageWeblet();
