...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/RemoveProductGalleryImageWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('gallery');

$weblet =& new RemoveProductGalleryImageWeblet();
$weblet->autoconfigure($GLOBALS['configuration']);
$weblet->setConnection($GLOBALS['dbConnection']);
$weblet->setGalleryId($id);
$weblet->run();
