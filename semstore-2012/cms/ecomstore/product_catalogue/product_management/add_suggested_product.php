...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/AddProductSuggestedProductWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('productid');

$weblet =& new AddProductSuggestedProductWeblet();
$weblet->autoconfigure($GLOBALS['configuration']);
$weblet->setConnection($GLOBALS['dbConnection']);
$weblet->setParentProductId($id);
$weblet->run();
