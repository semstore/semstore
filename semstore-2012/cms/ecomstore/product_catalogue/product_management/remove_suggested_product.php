...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/RemoveSuggestedProductWeblet.class.php');

Session::start();

$productid = RequestParameters::getParameter('suggestedproductid');

$weblet =& new RemoveSuggestedProductWeblet();
$weblet->autoconfigure($GLOBALS['configuration']);
$weblet->setConnection($GLOBALS['dbConnection']);
$weblet->setProductLinkId($productid);
$weblet->run();
