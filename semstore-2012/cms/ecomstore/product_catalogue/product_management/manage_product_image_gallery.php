...
//require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/UploadProductImagesWeblet.class.php');
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/ManageProductImageGalleryWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('productid');

$weblet =& new ManageProductImageGalleryWeblet();
$weblet->autoconfigure(Configuration::getInstance());
$weblet->setConnection($GLOBALS['dbConnection']);
$weblet->setProductId($id);
$weblet->run();
