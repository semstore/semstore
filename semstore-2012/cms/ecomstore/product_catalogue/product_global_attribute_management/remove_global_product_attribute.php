...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/RemoveGlobalProductAttributeWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('attributeid');

$weblet =& new RemoveGlobalProductAttributeWeblet();
$weblet->autoconfigure($GLOBALS['configuration']);
$weblet->setConnection($GLOBALS['dbConnection']);
$weblet->setAttributeId($id);
$weblet->run();
