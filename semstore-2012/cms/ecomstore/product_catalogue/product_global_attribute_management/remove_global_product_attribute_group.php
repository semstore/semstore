...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/RemoveGlobalProductAttributeGroupWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('groupid');

$weblet =& new RemoveGlobalProductAttributeGroupWeblet();
$weblet->autoconfigure($GLOBALS['configuration']);
$weblet->setConnection($GLOBALS['dbConnection']);
$weblet->setGroupId($id);
$weblet->run();
