...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/RemoveCustomerGroupAttributeGroupWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('groupid');

$weblet =& new RemoveCustomerGroupAttributeGroupWeblet();
$weblet->autoconfigure($GLOBALS['configuration']);
$weblet->setConnection($GLOBALS['dbConnection']);
$weblet->setAttributeGroupId($id);
$weblet->run();
