...
require_once('SEM/CMS/Modules/eComStore/CMS/Weblets/EditCustomerGroupAttributeGroupWeblet.class.php');

Session::start();

$id = RequestParameters::getParameter('groupid');

$weblet =& new EditCustomerGroupAttributeGroupWeblet();
$weblet->autoconfigure($GLOBALS['configuration']);
$weblet->setConnection($GLOBALS['dbConnection']);
$weblet->setCustomerGroupId($id);
$weblet->run();
